...
def get_kpsadmin(i):
    ...
    if kpsadmin:
        pays = country_common.get_countries_translated(i)# get the country translate assign them to pays

        kpsadmin['country'] = pays[kpsadmin['country']]# now put them in country backend
