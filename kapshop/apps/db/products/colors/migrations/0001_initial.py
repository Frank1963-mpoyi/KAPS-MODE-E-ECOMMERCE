    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=kapshop.core.utils.color_randcode_gen, max_length=100, verbose_name='CODE')),
                ('title', models.CharField(blank=True, max_length=250, null=True, verbose_name='TITLE')),
                ('shade', models.CharField(blank=True, max_length=250, null=True, verbose_name='SHADE')),
                ('description', models.TextField(blank=True, null=True, verbose_name='DESCRIPTION')),
                ('bool_shade', models.BooleanField(default=False, verbose_name='IS SHADE')),
                ('color', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='colors', to='colors.color')),
            ],
            options={
