    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=kapshop.core.utils.size_randcode_gen, max_length=100, verbose_name='CODE')),
                ('title', models.CharField(blank=True, max_length=250, null=True, verbose_name='TITLE')),
                ('size_number', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='NUMBER')),
                ('size_symbol', models.CharField(blank=True, max_length=5, null=True, verbose_name='SYMBOL')),
                ('country_orig', models.CharField(blank=True, max_length=5, null=True, verbose_name='ORIGIN COUNTRY')),
