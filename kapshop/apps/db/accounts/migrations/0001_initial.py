# Generated by Django 3.2.4 on 2021-11-11 16:27

import django.core.validators
from django.db import migrations, models
import django_countries.fields
import kapshop.apps.db.accounts.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=kapshop.apps.db.accounts.models.upload_img_path, verbose_name='IMAGE')),
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'MPT Systems'), (2, 'KPS Staff'), (3, 'Customer')], default=3, verbose_name='USER TYPE')),
