...
class UserLevelMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        mpoyi_user_type = 'MTC'   # Mpoyi Tshibuyi Company STAFF
        kps_user_type = 'KPS'   # Kaps Mode Company  STAFF
        cus_user_type = 'CUS'   # CUSTOMERS  - 'CUS-GEN-1' ==> GENERIC CUSTOMER
        ...
        if user_type == 1:
            allowed_user_type = [mpoyi_user_type, kps_user_type, cus_user_type]

        if user_type == 2:
            allowed_user_type = [kps_user_type, cus_user_type]
