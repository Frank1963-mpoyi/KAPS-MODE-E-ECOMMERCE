...
from kapshop.common.global_choices                       import CURRENCIES
...
class OrdersDetailFields(models.Model):
    ...
    '''
        ...
        2. Adding a billing addresses - (Handle Failed checkout)
...
class ProductStockFields(models.Model):
    ...
    bool_on_sale    = models.BooleanField('IS ON SALE',                                 default=False)

    class Meta:
        abstract = True

class ProductCategoryFields(models.Model):

    bool_new            = models.BooleanField('IS NEW',                             default=True)
    bool_baby           = models.BooleanField('FOR BABY',                           blank=True,         null=True)
    bool_child          = models.BooleanField('FOR CHILD',                          blank=True,         null=True)
    bool_adult          = models.BooleanField('FOR ADULT',                          blank=True,         null=True)
    bool_teen           = models.BooleanField('FOR TEEN',                           blank=True,         null=True)
    bool_female         = models.BooleanField('IS FEMALE PRODUCT',                  blank=True,         null=True)
    bool_male           = models.BooleanField('IS MALE PRODUCT',                    blank=True,         null=True)
